...
<article>
    <div class="card center" style="width: 30rem;">
        ...
        <div class="card-body">
            <form:form action="/login/on" modelAttribute="taikhoan">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" name="passTK" value="${passTK}">
                </div>
                ...
                <center>
                    <a href="/forgot-password" style="color: #157347;text-decoration: none;">Quên mật khẩu?</a>
                </center>
            </form:form>
        </div>
    </div>
    <br>
   <center>
       <h6 style="color: #157347">Chưa có tài khoản? </h6>
       <a href="/signup"><button class="btn btn-success" type="button" style="width: 200px">Đăng kí</button></a>
   </center>
</article>
<br>
